...
class SiteOrigin_Widget_Counterup_Widget extends SiteOrigin_Widget {

	function __construct() {

		parent::__construct(
			'sow-counter',
			__( 'SiteOrigin Counterup', 'so-widgets-bundle' ),
			array(
	...
	function get_widget_form(){
		return array(
            'counter' => array(
                'type' => 'repeater',
                'label'  => __( 'count', 'so-widgets-bundle' ),
				'hide'   => true,
                'fields' => array(
                    'headline' => array(
                        'type' => 'section',
	...
	function get_template_variables( $instance, $args ) {
        ...
        $counter1 = $instance['counter'];
        echo $counter1['headline']; 


		return array(
            'counter' => $instance['counter'],
			'headline' => $instance['counter']['headline']['text'],
...
siteorigin_widget_register('sow-counter', __FILE__, 'SiteOrigin_Widget_Counterup_Widget');
